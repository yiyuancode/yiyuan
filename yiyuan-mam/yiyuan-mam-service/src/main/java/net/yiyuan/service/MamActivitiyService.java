 ...
 * @date 2023-10-09
 */
public interface MamActivitiyService extends JoinIService<MamActivitiy> {
   ...
   * @date 2023-10-09
   */
  List<MamActivitiyQueryVO> list(MamActivitiyListDTO request) throws Exception;
   ...
   * @date 2023-10-09
   */
  Page<MamActivitiyQueryVO> page(MamActivitiyPageDTO request) throws Exception;
