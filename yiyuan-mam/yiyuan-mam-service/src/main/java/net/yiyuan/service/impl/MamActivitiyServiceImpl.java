...
@Slf4j
@Service
public class MamActivitiyServiceImpl extends JoinServiceImpl<MamActivitiyMapper, MamActivitiy>
   ...
   */
  @Override
  public List<MamActivitiyQueryVO> list(MamActivitiyListDTO request) throws Exception {

    MamActivitiy po = new MamActivitiy();
    BeanUtilsPlus.copy(request, po);
    JoinLambdaWrapper<MamActivitiy> wrapper = new JoinLambdaWrapper<>(po);
    wrapper.orderByDesc(MamActivitiy::getCreateTime);
    List<MamActivitiyQueryVO> voList =
        mamActivitiyMapper.joinSelectList(wrapper, MamActivitiyQueryVO.class);
   ...
   */
  @Override
  public Page<MamActivitiyQueryVO> page(MamActivitiyPageDTO request) throws Exception {
    MamActivitiy po = new MamActivitiy();
    BeanUtilsPlus.copy(request, po);
    JoinLambdaWrapper<MamActivitiy> wrapper = new JoinLambdaWrapper<>(po);
    wrapper.orderByDesc(MamActivitiy::getCreateTime);
    Page<MamActivitiyQueryVO> voPage =
        mamActivitiyMapper.joinSelectPage(
            new Page<>(request.getPageNum(), request.getPageSize()),
            wrapper,
            MamActivitiyQueryVO.class);
    return voPage;
  }
  ...
  public MamActivitiyQueryVO details(String id) throws Exception {
    ...
    po.setId(id);
    JoinLambdaWrapper<MamActivitiy> wrapper = new JoinLambdaWrapper<>(po);
    MamActivitiyQueryVO voBean =
        mamActivitiyMapper.joinSelectOne(wrapper, MamActivitiyQueryVO.class);
    return voBean;
  }
  ...
  public MamActivitiyQueryVO details(MamActivitiy request) throws Exception {
    JoinLambdaWrapper<MamActivitiy> wrapper = new JoinLambdaWrapper<>(request);
    MamActivitiyQueryVO voBean =
        mamActivitiyMapper.joinSelectOne(wrapper, MamActivitiyQueryVO.class);
    return voBean;
  }
