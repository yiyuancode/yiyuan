...
public class MamActivitiyController {
  @Autowired private MamActivitiyService mamActivitiyService;
  ...
  @ResponseBody
  public CommonResult<List<MamActivitiyQueryVO>> list(MamActivitiyListDTO request)
      throws Exception {
  ...
  @ResponseBody
  public CommonResult<Page<MamActivitiyQueryVO>> page(MamActivitiyPageDTO request)
      throws Exception {
  ...
  @ResponseBody
  public CommonResult<String> add(@RequestBody @Validated MamActivitiyAddDTO request)
      throws Exception {
