...
import net.yiyuan.filecontext.FileOperatorContext;
import net.yiyuan.model.FileInfo;
import net.yiyuan.mapper.FileInfoMapper;
import net.yiyuan.operator.FileOperatorInter;
...
@Slf4j
@Service
public class FileInfoServiceImpl extends JoinServiceImpl<FileInfoMapper, FileInfo> implements FileInfoService {
     ...
     */
    @Override
    public Page<FileInfo> pages(FileInfo request, Integer pageSize, Integer pageNum) throws Exception {
        JoinLambdaWrapper<FileInfo> wrapper = new JoinLambdaWrapper<>(request);
    ...
    @Override
    public void downloadToResponse(String id, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    private FileOperatorInter getOperatorByType(FileInfo fileinfo) {
        ...
        //确认目标文件存储类型
        FileEnum.Type type = Enums.getOptionalByValue(FileEnum.Type.class, fileinfo.getType())
