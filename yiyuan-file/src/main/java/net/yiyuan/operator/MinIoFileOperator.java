...
public class MinIoFileOperator extends AbstractFileOperator {
  ...
  public ObjectResponse uploadFile(UploadRequestParam requestParam, InputStream inputStream) {
    ...
    PutObjectArgs objectArgs =
        PutObjectArgs.builder().bucket(bucketName).object(requestParam.getKey()).stream(
                inputStream,
                requestParam.getSize() == null ? -1 : requestParam.getSize(),
                requestParam.getPartSize() == null
                    ? ObjectWriteArgs.MIN_MULTIPART_SIZE
                    : requestParam.getPartSize())
      ...
      ObjectWriteResponse writeResponse =
          minioClient.copyObject(
              CopyObjectArgs.builder()
                  ...
                  .bucket(targetParam.getBucketName())
                  .object(targetParam.getKey())
