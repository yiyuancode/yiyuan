...
public enum SysHostIsMonitorQueryCountParticleEnum implements IEnum<Integer> {
  /**
   * 按每分钟#0=每5分钟|1=每小时|2=每天|3=每周|4=每月
   *
   * @author ${author}
   * @date 2023-07-27
   * @see SysHostIsMonitorQueryCountParticleEnum
   */
  BY_MINUTE_5(0, "每5分钟"),
  ...
  SysHostIsMonitorQueryCountParticleEnum(int value, String desc) {
    this.value = value;
    this.desc = desc;
  }
