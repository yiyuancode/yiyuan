...
public class AuthRoleController {
  ...
  @ResponseBody
  public CommonResult<Page<AuthRoleQueryVO>> page(AuthRolePageDTO request) throws Exception {
  ...
  @ResponseBody
  public CommonResult<AuthRoleQueryVO> details(@PathVariable("id") @NotBlank String id)
      throws Exception {
  ...
  @ResponseBody
  public CommonResult<String> edit(@RequestBody @Validated AuthRoleEditDTO request)
      throws Exception {
