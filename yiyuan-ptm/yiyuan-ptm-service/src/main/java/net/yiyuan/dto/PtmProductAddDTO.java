...
public class PtmProductAddDTO implements Serializable {
    ...
    @NotNull(message = "库存(根据sku所有累计库存自动设置)不能为空")
    ...
    @NotNull(message = "售卖价格(根据sku最低售卖价格自动设置)不能为空")
    ...
    @NotNull(message = "划线价格(根据sku最低划线价格自动设置)不能为空")
    ...
    @NotNull(message = "成本价(根据sku最低成本价自动设置)不能为空")
