 ...
 * @date 2023-10-09
 */
public interface PtmProductAttrKeyService extends JoinIService<PtmProductAttrKey> {
   ...
   * @date 2023-10-09
   */
  List<PtmProductAttrKeyQueryVO> list(PtmProductAttrKeyListDTO request) throws Exception;
   ...
   * @date 2023-10-09
   */
  Page<PtmProductAttrKeyQueryVO> page(PtmProductAttrKeyPageDTO request) throws Exception;
