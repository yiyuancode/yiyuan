...
@Slf4j
@Service
public class PtmProductBrandServiceImpl extends JoinServiceImpl
    ...
    @Override
    public List
            <PtmProductBrandQueryVO> list(PtmProductBrandListDTO request) throws Exception {

        PtmProductBrand po = new PtmProductBrand();
        BeanUtilsPlus.copy(request, po);
        JoinLambdaWrapper
                <PtmProductBrand> wrapper = new JoinLambdaWrapper<>(po);
        wrapper.orderByDesc(PtmProductBrand::getSort);
        wrapper.orderByDesc(PtmProductBrand::getCreateTime);
        List
                <PtmProductBrandQueryVO> voList = ptmProductBrandMapper.joinSelectList(wrapper, PtmProductBrandQueryVO.class);
    ...
    @Override
    public Page
            <PtmProductBrandQueryVO> page(PtmProductBrandPageDTO request) throws Exception {
        PtmProductBrand po = new PtmProductBrand();
        BeanUtilsPlus.copy(request, po);
        JoinLambdaWrapper
                <PtmProductBrand> wrapper = new JoinLambdaWrapper<>(po);
        ...
        wrapper.orderByDesc(PtmProductBrand::getCreateTime);
        Page
                <PtmProductBrandQueryVO> voPage =
                ptmProductBrandMapper.joinSelectPage(
                        new Page<>(request.getPageNum(), request.getPageSize()), wrapper, PtmProductBrandQueryVO.class);
        return voPage;
    }
    ...
    public PtmProductBrandQueryVO details(String id) throws Exception {
        ...
        JoinLambdaWrapper
                <PtmProductBrand> wrapper = new JoinLambdaWrapper<>(po);
        PtmProductBrandQueryVO voBean = ptmProductBrandMapper.joinSelectOne(wrapper, PtmProductBrandQueryVO.class);
        return voBean;
    }
    ...
    public PtmProductBrandQueryVO details(PtmProductBrand request) throws Exception {
        JoinLambdaWrapper
                <PtmProductBrand> wrapper = new JoinLambdaWrapper<>(request);
        PtmProductBrandQueryVO voBean = ptmProductBrandMapper.joinSelectOne(wrapper, PtmProductBrandQueryVO.class);
        return voBean;
    }
