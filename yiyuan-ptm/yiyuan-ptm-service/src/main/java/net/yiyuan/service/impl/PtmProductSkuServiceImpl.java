...
@Slf4j
@Service
public class PtmProductSkuServiceImpl extends JoinServiceImpl
        <PtmProductSkuMapper, PtmProductSku>
        implements PtmProductSkuService {
    @Resource
    private PtmProductSkuMapper ptmProductSkuMapper;
    ...
    public List
        ...
        JoinLambdaWrapper
                <PtmProductSku> wrapper = new JoinLambdaWrapper<>(po);
        wrapper.orderByDesc(PtmProductSku::getCreateTime);
        List
                <PtmProductSkuQueryVO> voList = ptmProductSkuMapper.joinSelectList(wrapper, PtmProductSkuQueryVO.class);
    ...
    public Page
        ...
        wrapper.orderByDesc(PtmProductSku::getCreateTime);
        Page
                <PtmProductSkuQueryVO> voPage =
                ptmProductSkuMapper.joinSelectPage(
                        new Page<>(request.getPageNum(), request.getPageSize()), wrapper, PtmProductSkuQueryVO.class);
        return voPage;
    }
    ...
    public PtmProductSkuQueryVO details(String id) throws Exception {
        ...
        JoinLambdaWrapper
                <PtmProductSku> wrapper = new JoinLambdaWrapper<>(po);
        PtmProductSkuQueryVO voBean = ptmProductSkuMapper.joinSelectOne(wrapper, PtmProductSkuQueryVO.class);
        return voBean;
    }
    ...
    public PtmProductSkuQueryVO details(PtmProductSku request) throws Exception {
        JoinLambdaWrapper
                <PtmProductSku> wrapper = new JoinLambdaWrapper<>(request);
        PtmProductSkuQueryVO voBean = ptmProductSkuMapper.joinSelectOne(wrapper, PtmProductSkuQueryVO.class);
        return voBean;
    }
