 ...
 * @date 2023-10-09
 */
public interface PtmProductSkuService extends JoinIService<PtmProductSku> {
   ...
   * @date 2023-10-09
   */
  List<PtmProductSkuQueryVO> list(PtmProductSkuListDTO request) throws Exception;
   ...
   * @date 2023-10-09
   */
  Page<PtmProductSkuQueryVO> page(PtmProductSkuPageDTO request) throws Exception;
