...
@Slf4j
@Service
public class PtmProductAttrValueServiceImpl
    extends JoinServiceImpl<PtmProductAttrValueMapper, PtmProductAttrValue>
    implements PtmProductAttrValueService {
  @Resource private PtmProductAttrValueMapper ptmProductAttrValueMapper;
   ...
   */
  @Override
  public List<PtmProductAttrValueQueryVO> list(PtmProductAttrValueListDTO request)
      throws Exception {

    PtmProductAttrValue po = new PtmProductAttrValue();
    BeanUtilsPlus.copy(request, po);
    JoinLambdaWrapper<PtmProductAttrValue> wrapper = new JoinLambdaWrapper<>(po);
    wrapper.orderByDesc(PtmProductAttrValue::getCreateTime);
    List<PtmProductAttrValueQueryVO> voList =
        ptmProductAttrValueMapper.joinSelectList(wrapper, PtmProductAttrValueQueryVO.class);
   ...
   */
  @Override
  public Page<PtmProductAttrValueQueryVO> page(PtmProductAttrValuePageDTO request)
      throws Exception {
    PtmProductAttrValue po = new PtmProductAttrValue();
    BeanUtilsPlus.copy(request, po);
    JoinLambdaWrapper<PtmProductAttrValue> wrapper = new JoinLambdaWrapper<>(po);
    wrapper.orderByDesc(PtmProductAttrValue::getCreateTime);
    Page<PtmProductAttrValueQueryVO> voPage =
        ptmProductAttrValueMapper.joinSelectPage(
            new Page<>(request.getPageNum(), request.getPageSize()),
            wrapper,
            PtmProductAttrValueQueryVO.class);
    return voPage;
  }
  ...
  public PtmProductAttrValueQueryVO details(String id) throws Exception {
    ...
    po.setId(id);
    JoinLambdaWrapper<PtmProductAttrValue> wrapper = new JoinLambdaWrapper<>(po);
    PtmProductAttrValueQueryVO voBean =
        ptmProductAttrValueMapper.joinSelectOne(wrapper, PtmProductAttrValueQueryVO.class);
    return voBean;
  }
  ...
  public PtmProductAttrValueQueryVO details(PtmProductAttrValue request) throws Exception {
    JoinLambdaWrapper<PtmProductAttrValue> wrapper = new JoinLambdaWrapper<>(request);
    PtmProductAttrValueQueryVO voBean =
        ptmProductAttrValueMapper.joinSelectOne(wrapper, PtmProductAttrValueQueryVO.class);
    return voBean;
  }
