...
@Slf4j
@Service
public class PtmProductDetailsServiceImpl
    extends JoinServiceImpl<PtmProductDetailsMapper, PtmProductDetails>
    implements PtmProductDetailsService {
  @Resource private PtmProductDetailsMapper ptmProductDetailsMapper;
   ...
   */
  @Override
  public List<PtmProductDetailsQueryVO> list(PtmProductDetailsListDTO request) throws Exception {

    PtmProductDetails po = new PtmProductDetails();
    BeanUtilsPlus.copy(request, po);
    JoinLambdaWrapper<PtmProductDetails> wrapper = new JoinLambdaWrapper<>(po);
    List<PtmProductDetailsQueryVO> voList =
        ptmProductDetailsMapper.joinSelectList(wrapper, PtmProductDetailsQueryVO.class);
   ...
   */
  @Override
  public Page<PtmProductDetailsQueryVO> page(PtmProductDetailsPageDTO request) throws Exception {
    PtmProductDetails po = new PtmProductDetails();
    BeanUtilsPlus.copy(request, po);
    JoinLambdaWrapper<PtmProductDetails> wrapper = new JoinLambdaWrapper<>(po);
    Page<PtmProductDetailsQueryVO> voPage =
        ptmProductDetailsMapper.joinSelectPage(
            new Page<>(request.getPageNum(), request.getPageSize()),
            wrapper,
            PtmProductDetailsQueryVO.class);
    return voPage;
  }
  ...
  public PtmProductDetailsQueryVO details(String id) throws Exception {
    ...
    po.setId(id);
    JoinLambdaWrapper<PtmProductDetails> wrapper = new JoinLambdaWrapper<>(po);
    PtmProductDetailsQueryVO voBean =
        ptmProductDetailsMapper.joinSelectOne(wrapper, PtmProductDetailsQueryVO.class);
    return voBean;
  }
  ...
  public PtmProductDetailsQueryVO details(PtmProductDetails request) throws Exception {
    JoinLambdaWrapper<PtmProductDetails> wrapper = new JoinLambdaWrapper<>(request);
    PtmProductDetailsQueryVO voBean =
        ptmProductDetailsMapper.joinSelectOne(wrapper, PtmProductDetailsQueryVO.class);
    return voBean;
  }
