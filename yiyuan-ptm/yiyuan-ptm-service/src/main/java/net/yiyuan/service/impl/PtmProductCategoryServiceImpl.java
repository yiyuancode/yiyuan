...
@Slf4j
@Service
public class PtmProductCategoryServiceImpl extends JoinServiceImpl
    ...
    @Override
    public List
            <PtmProductCategoryQueryVO> list(PtmProductCategoryListDTO request) throws Exception {

        PtmProductCategory po = new PtmProductCategory();
        BeanUtilsPlus.copy(request, po);
        JoinLambdaWrapper
                <PtmProductCategory> wrapper = new JoinLambdaWrapper<>(po);
        wrapper.orderByDesc(PtmProductCategory::getSort);
        wrapper.orderByDesc(PtmProductCategory::getCreateTime);
        List
                <PtmProductCategoryQueryVO> voList = ptmProductCategoryMapper.joinSelectList(wrapper, PtmProductCategoryQueryVO.class);
    ...
    @Override
    public Page
            <PtmProductCategoryQueryVO> page(PtmProductCategoryPageDTO request) throws Exception {
        PtmProductCategory po = new PtmProductCategory();
        BeanUtilsPlus.copy(request, po);
        JoinLambdaWrapper
                <PtmProductCategory> wrapper = new JoinLambdaWrapper<>(po);
        ...
        wrapper.orderByDesc(PtmProductCategory::getCreateTime);
        Page
                <PtmProductCategoryQueryVO> voPage =
                ptmProductCategoryMapper.joinSelectPage(
                        new Page<>(request.getPageNum(), request.getPageSize()), wrapper, PtmProductCategoryQueryVO.class);
        return voPage;
    }
    ...
    public PtmProductCategoryQueryVO details(String id) throws Exception {
        ...
        JoinLambdaWrapper
                <PtmProductCategory> wrapper = new JoinLambdaWrapper<>(po);
        PtmProductCategoryQueryVO voBean = ptmProductCategoryMapper.joinSelectOne(wrapper, PtmProductCategoryQueryVO.class);
        return voBean;
    }
    ...
    public PtmProductCategoryQueryVO details(PtmProductCategory request) throws Exception {
        JoinLambdaWrapper
                <PtmProductCategory> wrapper = new JoinLambdaWrapper<>(request);
        PtmProductCategoryQueryVO voBean = ptmProductCategoryMapper.joinSelectOne(wrapper, PtmProductCategoryQueryVO.class);
        return voBean;
    }
