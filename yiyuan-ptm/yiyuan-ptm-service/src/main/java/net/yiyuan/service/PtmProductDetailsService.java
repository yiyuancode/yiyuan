 ...
 * @date 2023-10-09
 */
public interface PtmProductDetailsService extends JoinIService<PtmProductDetails> {
   ...
   * @date 2023-10-09
   */
  List<PtmProductDetailsQueryVO> list(PtmProductDetailsListDTO request) throws Exception;
   ...
   * @date 2023-10-09
   */
  Page<PtmProductDetailsQueryVO> page(PtmProductDetailsPageDTO request) throws Exception;
