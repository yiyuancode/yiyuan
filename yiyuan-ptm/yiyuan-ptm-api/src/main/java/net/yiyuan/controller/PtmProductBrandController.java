...
public class PtmProductBrandController {
    @Autowired
    private PtmProductBrandService ptmProductBrandService;
    ...
    @ResponseBody
    public CommonResult<List<PtmProductBrandQueryVO>> list(PtmProductBrandListDTO request) throws Exception {
    ...
    @ResponseBody
    public CommonResult<Page<PtmProductBrandQueryVO>> page(PtmProductBrandPageDTO request) throws Exception {
    ...
    @ResponseBody
    public CommonResult<String> add(@RequestBody @Validated PtmProductBrandAddDTO request) throws Exception {
