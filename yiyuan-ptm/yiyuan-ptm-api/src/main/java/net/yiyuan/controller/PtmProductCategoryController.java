...
public class PtmProductCategoryController {
    @Autowired
    private PtmProductCategoryService ptmProductCategoryService;
    ...
    @ResponseBody
    public CommonResult<List<PtmProductCategoryQueryVO>> list(PtmProductCategoryListDTO request) throws Exception {
    ...
    @ResponseBody
    public CommonResult<Page<PtmProductCategoryQueryVO>> page(PtmProductCategoryPageDTO request) throws Exception {
    ...
    @ResponseBody
    public CommonResult<String> add(@RequestBody @Validated PtmProductCategoryAddDTO request) throws Exception {
