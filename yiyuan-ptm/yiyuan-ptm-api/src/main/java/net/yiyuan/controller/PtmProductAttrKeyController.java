...
public class PtmProductAttrKeyController {
  @Autowired private PtmProductAttrKeyService ptmProductAttrKeyService;
  ...
  @ResponseBody
  public CommonResult<List<PtmProductAttrKeyQueryVO>> list(PtmProductAttrKeyListDTO request)
      throws Exception {
  ...
  @ResponseBody
  public CommonResult<Page<PtmProductAttrKeyQueryVO>> page(PtmProductAttrKeyPageDTO request)
      throws Exception {
  ...
  @ResponseBody
  public CommonResult<String> add(@RequestBody @Validated PtmProductAttrKeyAddDTO request)
      throws Exception {
  ...
  @SaCheckPermission(
      value = {"ptm:productAttrKey:query"},
      orRole = "admin")
  @GetMapping(value = "/ptm/productAttrKey/getAttrByCategoryId/{categoryId}")
  @ResponseBody
  public CommonResult<Map<String, List<String>>> getAttrByCategoryId(
      @PathVariable("categoryId") @NotBlank String categoryId) throws Exception {
    return CommonResult.success(ptmProductAttrKeyService.getAttrByCategoryId(categoryId), "");
  }
}
