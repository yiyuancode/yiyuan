...
public class PtmProductSkuController {
    @Autowired
    private PtmProductSkuService ptmProductSkuService;
    ...
    @ResponseBody
    public CommonResult<List<PtmProductSkuQueryVO>> list(PtmProductSkuListDTO request) throws Exception {
    ...
    @ResponseBody
    public CommonResult<Page<PtmProductSkuQueryVO>> page(PtmProductSkuPageDTO request) throws Exception {
    ...
    @ResponseBody
    public CommonResult<String> add(@RequestBody @Validated PtmProductSkuAddDTO request) throws Exception {
