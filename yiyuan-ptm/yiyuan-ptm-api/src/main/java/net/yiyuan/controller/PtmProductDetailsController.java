...
public class PtmProductDetailsController {
    @Autowired
    private PtmProductDetailsService ptmProductDetailsService;
    ...
    @ResponseBody
    public CommonResult<List<PtmProductDetailsQueryVO>> list(PtmProductDetailsListDTO request) throws Exception {
    ...
    @ResponseBody
    public CommonResult<Page<PtmProductDetailsQueryVO>> page(PtmProductDetailsPageDTO request) throws Exception {
    ...
    @ResponseBody
    public CommonResult<String> add(@RequestBody @Validated PtmProductDetailsAddDTO request) throws Exception {
