...
public class PtmProductAttrValueController {
  @Autowired private PtmProductAttrValueService ptmProductAttrValueService;
  ...
  @ResponseBody
  public CommonResult<List<PtmProductAttrValueQueryVO>> list(PtmProductAttrValueListDTO request)
      throws Exception {
  ...
  @ResponseBody
  public CommonResult<Page<PtmProductAttrValueQueryVO>> page(PtmProductAttrValuePageDTO request)
      throws Exception {
  ...
  @ResponseBody
  public CommonResult<String> add(@RequestBody @Validated PtmProductAttrValueAddDTO request)
      throws Exception {
