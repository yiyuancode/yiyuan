...
public class CheckUtil {
  ...
  public static boolean isLicense18(String license) {
    if (StringUtils.isEmpty(license)) {
      ...
      String regex =
          "^([1-9ANY]{1})([123459]{1})([0-9ABCDEFGHJKLMNPQRTUWXY]{6})([0-9ABCDEFGHJKLMNPQRTUWXY]{9})([0-90-9ABCDEFGHJKLMNPQRTUWXY])$";
      if (!license.matches(regex)) {
        ...
        String[] codes =
            new String[] {
              license.substring(0, license.length() - 1),
              license.substring(license.length() - 1, license.length())
            };
        int sum = 0;
