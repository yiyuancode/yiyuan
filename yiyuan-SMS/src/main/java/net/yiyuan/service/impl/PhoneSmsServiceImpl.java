...
public class PhoneSmsServiceImpl implements SmsAndEmailService {
  ...
  @Resource private SmsConfig smsConfig;
  ...
  public boolean checkSmsCode(String phoneOrEmail, String code) {
    ...
    String scode =
        smsRedisService.get(SmsRedisService.REDIS_KEY_SMS_PERMISSION, phoneOrEmail, String.class);
  ...
  public CommonResult<?> doSingleTplSms(SmsCode smsCode) throws ClientException {
    ...
    DefaultProfile profile =
        DefaultProfile.getProfile(
            "ap-northeast-1", smsConfig.getAppKey(), smsConfig.getAppSecure());
  ...
  public SmsCode buildSmsCode(String phone) {
    ...
    if (smsRedisService.get(SmsRedisService.REDIS_KEY_SMS_PERMISSION, phone, String.class)
        != null) {
