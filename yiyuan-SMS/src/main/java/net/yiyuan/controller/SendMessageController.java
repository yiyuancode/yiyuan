...
public class SendMessageController {
  ...
  @Resource private ActiveEmailAndSmsService activeEmailAndSmsService;
  ...
  public CommonResult<String> verifySms(@RequestParam(name = "phoneOrEmail") String phoneOrEmail)
      throws Exception {
  ...
  public CommonResult<String> checkSmsCode(
      @RequestParam(name = "codeId") String codeId, @RequestParam(name = "code") String code) {
