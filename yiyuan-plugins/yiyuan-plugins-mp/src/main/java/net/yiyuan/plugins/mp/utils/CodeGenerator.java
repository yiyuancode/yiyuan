...
public class CodeGenerator {
  ...
  public static void main(String[] args) throws Exception {
    ...
    DEFAULT_PARENT_PACK = "net.yiyuan";
  ...
  public static void getTableFiled(String inputTableName[], PackageConfig pc) throws Exception {
    ...
    for (String tableName : inputTableName) {
      ...
      if (hasKeyFlag == 1) {
        ...
        createJsRouterPm0JsByVelocity(dtoContext);
        createJsRouterPm1JsByVelocity(dtoContext);
      }
    }
   ...
   * @date 2023-07-11
   */
  public static void createModelPomByVelocity(VelocityContext context) throws Exception {
    ...
    Template template = velocityEngine.getTemplate("templates2/model.pom.vm", "UTF-8");
   ...
   * @date 2023-07-11
   */
  public static void createJsRouterPm0JsByVelocity(VelocityContext context) throws Exception {
    VelocityEngine velocityEngine = new VelocityEngine();
    Properties prop = new Properties();
    prop.put(
        "file.resource.loader.class",
    ...
    Template template = velocityEngine.getTemplate("templates2/router.index.js.vm", "UTF-8");
    FileWriter writer = new FileWriter(filePath);
    template.merge(context, writer);
    writer.flush();
    writer.close();
  ...
  public static void createJsRouterPm1JsByVelocity(VelocityContext context) throws Exception {
    VelocityEngine velocityEngine = new VelocityEngine();
    Properties prop = new Properties();
    prop.put(
        "file.resource.loader.class",
    ...
    Template template = velocityEngine.getTemplate("templates2/router.child.index.js.vm", "UTF-8");
    FileWriter writer = new FileWriter(filePath);
    template.merge(context, writer);
    writer.flush();
    writer.close();
