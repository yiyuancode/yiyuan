...
@Slf4j
@Service
public class UmUserAddressServiceImpl extends JoinServiceImpl
    ...
    public List
        ...
        JoinLambdaWrapper
                <UmUserAddress> wrapper = new JoinLambdaWrapper<>(po);
        List
                <UmUserAddressQueryVO> voList = umUserAddressMapper.joinSelectList(wrapper, UmUserAddressQueryVO.class);
    ...
    public Page
        ...
        JoinLambdaWrapper
                <UmUserAddress> wrapper = new JoinLambdaWrapper<>(po);
        Page
                <UmUserAddressQueryVO> voPage =
                umUserAddressMapper.joinSelectPage(
                        new Page<>(request.getPageNum(), request.getPageSize()), wrapper, UmUserAddressQueryVO.class);
        return voPage;
    }
    ...
    public UmUserAddressQueryVO details(String id) throws Exception {
        ...
        JoinLambdaWrapper
                <UmUserAddress> wrapper = new JoinLambdaWrapper<>(po);
        UmUserAddressQueryVO voBean = umUserAddressMapper.joinSelectOne(wrapper, UmUserAddressQueryVO.class);
        return voBean;
    }
    ...
    public UmUserAddressQueryVO details(UmUserAddress request) throws Exception {
        JoinLambdaWrapper
                <UmUserAddress> wrapper = new JoinLambdaWrapper<>(request);
        UmUserAddressQueryVO voBean = umUserAddressMapper.joinSelectOne(wrapper, UmUserAddressQueryVO.class);
        return voBean;
    }
