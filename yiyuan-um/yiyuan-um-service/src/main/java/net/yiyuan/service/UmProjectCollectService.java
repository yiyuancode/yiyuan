 ...
 * @date 2023-09-21
 */
public interface UmProjectCollectService extends JoinIService<UmProjectCollect> {
   ...
   * @date 2023-09-21
   */
  List<UmProjectCollectQueryVO> list(UmProjectCollectListDTO request) throws Exception;
   ...
   * @date 2023-09-21
   */
  Page<UmProjectCollectQueryVO> page(UmProjectCollectPageDTO request) throws Exception;
