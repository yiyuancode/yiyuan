...
@Slf4j
@Service
public class UmProjectCollectServiceImpl
   ...
   */
  @Override
  public List<UmProjectCollectQueryVO> list(UmProjectCollectListDTO request) throws Exception {

    UmProjectCollect po = new UmProjectCollect();
    BeanUtilsPlus.copy(request, po);
    JoinLambdaWrapper<UmProjectCollect> wrapper = new JoinLambdaWrapper<>(po);
    List<UmProjectCollectQueryVO> voList =
        umProjectCollectMapper.joinSelectList(wrapper, UmProjectCollectQueryVO.class);
   ...
   */
  @Override
  public Page<UmProjectCollectQueryVO> page(UmProjectCollectPageDTO request) throws Exception {
    UmProjectCollect po = new UmProjectCollect();
    BeanUtilsPlus.copy(request, po);
    JoinLambdaWrapper<UmProjectCollect> wrapper = new JoinLambdaWrapper<>(po);
    Page<UmProjectCollectQueryVO> voPage =
        umProjectCollectMapper.joinSelectPage(
            new Page<>(request.getPageNum(), request.getPageSize()),
            wrapper,
            UmProjectCollectQueryVO.class);
    return voPage;
  }
  ...
  public UmProjectCollectQueryVO details(String id) throws Exception {
    ...
    po.setId(id);
    JoinLambdaWrapper<UmProjectCollect> wrapper = new JoinLambdaWrapper<>(po);
    UmProjectCollectQueryVO voBean =
        umProjectCollectMapper.joinSelectOne(wrapper, UmProjectCollectQueryVO.class);
    return voBean;
  }
  ...
  public UmProjectCollectQueryVO details(UmProjectCollect request) throws Exception {
    JoinLambdaWrapper<UmProjectCollect> wrapper = new JoinLambdaWrapper<>(request);
    UmProjectCollectQueryVO voBean =
        umProjectCollectMapper.joinSelectOne(wrapper, UmProjectCollectQueryVO.class);
    return voBean;
  }
