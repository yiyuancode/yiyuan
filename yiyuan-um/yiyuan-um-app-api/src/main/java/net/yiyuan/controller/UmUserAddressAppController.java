...
public class UmUserAddressAppController {
  ...
  @ResponseBody
  public CommonResult<List<UmUserAddressQueryVO>> list(UmUserAddressListDTO request)
          throws Exception {
    return CommonResult.success(umUserAddressAppService.list(request), "查询用户地址列表成功");
  }
  ...
  @ResponseBody
  public CommonResult<Page<UmUserAddressQueryVO>> page(UmUserAddressPageDTO request)
          throws Exception {
    return CommonResult.success(umUserAddressAppService.page(request), "分页查询用户地址成功");
  }
  ...
  public CommonResult<UmUserAddressQueryVO> details(@PathVariable("id") @NotBlank String id)
          throws Exception {
    return CommonResult.success(umUserAddressAppService.details(id), "查询用户地址详情成功");
  }
  ...
  public CommonResult<String> delete(
    ...
    if (umUserAddressAppService.delete(ids)) {
  ...
  public CommonResult<String> edit(@RequestBody @Validated UmUserAddressEditDTO request)
          throws Exception {
    if (umUserAddressAppService.edit(request)) {
  ...
  @ResponseBody
  public CommonResult<String> add(@RequestBody @Validated UmUserAddressAddDTO request)
          throws Exception {
    if (umUserAddressAppService.add(request)) {
