...
public class UmProjectCollectController {
  @Autowired private UmProjectCollectService umProjectCollectService;
  ...
  @ResponseBody
  public CommonResult<List<UmProjectCollectQueryVO>> list(UmProjectCollectListDTO request)
      throws Exception {
  ...
  @ResponseBody
  public CommonResult<Page<UmProjectCollectQueryVO>> page(UmProjectCollectPageDTO request)
      throws Exception {
  ...
  @ResponseBody
  public CommonResult<String> add(@RequestBody @Validated UmProjectCollectAddDTO request)
      throws Exception {
