...
public class SkuUtil {
   ...
   * @return 转换为大写的字符串
   */
  //    public static List<List<String>> generateSkuCombinations(List<String> attrKeys,
  ...
  //    }
  //
  //    private static void generateCombinations(List<String> attrKeys, List<List<String>>
  // attrValues, int index,
  //                                             List<String> currentCombination, List<List<String>>
  // combinations) {
  ...
  //            generateCombinations(attrKeys, attrValues, index + 1, currentCombination,
  // combinations);
  ...
  public static List<Map<String, String>> generateCombinations(
      List<String> attrKeys, List<List<String>> attrValues) {
  ...
  public static Map<String, List<String>> reverseParseCombinations(
      List<Map<String, String>> combinations) {
    Map<String, Set<String>> attributes = new HashMap<>();
  ...
  public static Map<String, Object> getAttrKeysAndAttrValues(String str) {
    // 使用Fastjson库解析字符串
    //        Map<String, List<String>> attributesMap = JSON.parseObject(str, new
