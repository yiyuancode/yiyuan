...
public class AuthAdminController {
    ...
    @SaCheckPermission(value = {"auth:admin:query"}, orRole = "admin" )
    ...
    @ResponseBody
    public CommonResult<Page<AuthAdminQueryVO>> page(
            AuthAdminPageDTO request
    ) throws Exception {
    ...
    @SaCheckPermission(value = {"auth:admin:delete"}, orRole = "admin" )
    ...
    @SaCheckPermission(value = {"auth:admin:edit"}, orRole = "admin" )
    @PostMapping(value = "/auth/admin/edit" )
    @ResponseBody
    public CommonResult<String> edit(@RequestBody @Validated AuthAdminEditDTO request) throws Exception {
    ...
    @SaCheckPermission(value = {"auth:admin:add"}, orRole = "admin" )
    @PostMapping(value = "/auth/admin/add" )
    @ResponseBody
    public CommonResult<String> add(@RequestBody @Validated AuthAdminAddDTO request) throws Exception {
