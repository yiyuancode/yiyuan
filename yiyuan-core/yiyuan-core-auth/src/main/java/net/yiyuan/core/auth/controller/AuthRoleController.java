...
public class AuthRoleController {
  ...
  public CommonResult list(AuthRole request) throws Exception {
  ...
  public CommonResult details(AuthRole request) throws Exception {
  ...
  public CommonResult del(@RequestBody @Validated AuthRole request) throws Exception {
