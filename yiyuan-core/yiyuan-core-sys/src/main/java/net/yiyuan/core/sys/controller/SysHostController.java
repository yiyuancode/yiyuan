...
public class SysHostController {
    ...
    @ResponseBody
    public CommonResult<Page<SysHostQueryVO>> page(
            SysHostPageDTO request
    ) throws Exception {
    ...
    @SaCheckPermission(value = {"sys:host:delete"}, orRole = "admin" )
    ...
    @SaCheckPermission(value = {"sys:host:edit"}, orRole = "admin" )
    @PostMapping(value = "/sys/host/edit" )
    @ResponseBody
    public CommonResult<String> edit(@RequestBody @Validated SysHostEditDTO request) throws Exception {
