...
public class SysTenantController {
  ...
  public CommonResult list(SysTenant request) throws Exception {
  ...
  public CommonResult details(SysTenant request) throws Exception {
  ...
  public CommonResult del(@RequestBody @Validated SysTenant request) throws Exception {
