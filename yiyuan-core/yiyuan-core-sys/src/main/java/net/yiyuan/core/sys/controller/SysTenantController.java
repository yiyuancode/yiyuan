...
public class SysTenantController {
    ...
    @PostMapping(value = "/sys/tenant/list" )
    @ResponseBody
    public CommonResult<List<SysTenant>> list(@RequestBody SysTenant request) throws Exception {
    ...
    @Description("系统管理/租户管理/查询租户" )
    @SaCheckPermission(value = {"sys:tenant:query"}, orRole = "admin" )
    @PostMapping(value = "/sys/tenant/pages" )
    @ResponseBody
    public CommonResult<Page<SysTenant>> pages(
            @RequestBody SysTenant request,
    ...
    @ResponseBody
    public CommonResult<SysTenant> details(@PathVariable("id" ) @Validated({NotEmpty.class}) String id) throws Exception {
