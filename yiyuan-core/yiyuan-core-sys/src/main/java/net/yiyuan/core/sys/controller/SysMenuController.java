...
public class SysMenuController {
  ...
  public CommonResult list(SysMenu request) throws Exception {
  ...
  public CommonResult details(SysMenu request) throws Exception {
  ...
  public CommonResult del(@RequestBody @Validated SysMenu request) throws Exception {
