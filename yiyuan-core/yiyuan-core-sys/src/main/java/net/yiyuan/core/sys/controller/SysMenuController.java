...
public class SysMenuController {
    ...
    @SaCheckPermission(value = {"sys:menu:query"}, orRole = "admin" )
    @PostMapping(value = "/sys/menu/list" )
    @ResponseBody
    public CommonResult<List<SysMenu>> list(@RequestBody SysMenu request) throws Exception {
    ...
    @Description("系统管理/菜单管理/查询菜单" )
    @SaCheckPermission(value = {"sys:menu:query"}, orRole = "admin" )
    @PostMapping(value = "/sys/menu/pages" )
    @ResponseBody
    public CommonResult<Page<SysMenu>> pages(
            @RequestBody SysMenu request,
    ...
    @ResponseBody
    public CommonResult<SysMenu> details(@PathVariable("id" ) @Validated({NotEmpty.class}) String id) throws Exception {
