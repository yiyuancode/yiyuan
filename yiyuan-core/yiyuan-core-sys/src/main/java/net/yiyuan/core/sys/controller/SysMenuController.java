...
public class SysMenuController {
    ...
    @ResponseBody
    public CommonResult<Page<SysMenuQueryVO>> page(
            SysMenuPageDTO request
    ) throws Exception {
    ...
    @ResponseBody
    public CommonResult<String> edit(@RequestBody @Validated SysMenuEditDTO request) throws Exception {
    ...
    //@SaCheckPermission(value = {"sys:menu:autoScanMenu"}, orRole = "admin" )
    @SaIgnore
    ...
    public CommonResult<String> autoScanMenu() throws Exception {
        if (sysMenuService.autoScanMenu()) {
            return CommonResult.success(null, "自动生成菜单数据成功" );
        } else {
