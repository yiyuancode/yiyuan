...
import net.yiyuan.core.file.model.*;
...
public class FileInfoController {
     ...
     */
    @Description("文件管理//查询")
    @SaCheckPermission(value = {"file:info:query"}, orRole = "admin")
    ...
    @ResponseBody
    public CommonResult<FileInfo> details(@PathVariable("id") @Validated({NotEmpty.class}) String id) throws Exception {
     ...
     */
    @Description("文件管理//删除")
    @SaCheckPermission(value = {"file:info:delete"}, orRole = "admin")
    @PostMapping(value = "/file/info/delete")
    @ResponseBody
    public CommonResult<String> delete(@RequestParam @Validated({NotEmpty.class}) String ids) throws Exception {
     ...
     */
    @Description("文件管理//编辑")
    @SaCheckPermission(value = {"file:info:edit"}, orRole = "admin")
     ...
     */
    @Description("文件管理//新增")
    @SaCheckPermission(value = {"file:info:add"}, orRole = "admin")
