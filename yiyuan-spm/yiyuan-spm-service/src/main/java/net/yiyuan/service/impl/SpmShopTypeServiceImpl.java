...
@Slf4j
@Service
public class SpmShopTypeServiceImpl extends JoinServiceImpl
    ...
    @Override
    public List
            <SpmShopTypeQueryVO> list(SpmShopTypeListDTO request) throws Exception {

        SpmShopType po = new SpmShopType();
        BeanUtilsPlus.copy(request, po);
        JoinLambdaWrapper
                <SpmShopType> wrapper = new JoinLambdaWrapper<>(po);
        List
                <SpmShopTypeQueryVO> voList = spmShopTypeMapper.joinSelectList(wrapper, SpmShopTypeQueryVO.class);
    ...
    @Override
    public Page
            <SpmShopTypeQueryVO> page(SpmShopTypePageDTO request) throws Exception {
        SpmShopType po = new SpmShopType();
        BeanUtilsPlus.copy(request, po);
        JoinLambdaWrapper
                <SpmShopType> wrapper = new JoinLambdaWrapper<>(po);
        Page
                <SpmShopTypeQueryVO> voPage =
                    spmShopTypeMapper.joinSelectPage(
                new Page<>(request.getPageNum(), request.getPageSize()), wrapper, SpmShopTypeQueryVO.class);
        return voPage;
    }
    ...
    public SpmShopTypeQueryVO details(SpmShopType request) throws Exception {
        JoinLambdaWrapper
                <SpmShopType> wrapper = new JoinLambdaWrapper<>(request);
            SpmShopTypeQueryVO voBean = spmShopTypeMapper.joinSelectOne(wrapper, SpmShopTypeQueryVO.class);
        return voBean;
    }
