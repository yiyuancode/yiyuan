...
@Slf4j
@Service
public class SpmShopMainCategoryServiceImpl extends JoinServiceImpl
    ...
    @Override
    public List
            <SpmShopMainCategoryQueryVO> list(SpmShopMainCategoryListDTO request) throws Exception {

        SpmShopMainCategory po = new SpmShopMainCategory();
        BeanUtilsPlus.copy(request, po);
        JoinLambdaWrapper
                <SpmShopMainCategory> wrapper = new JoinLambdaWrapper<>(po);
        List
                <SpmShopMainCategoryQueryVO> voList = spmShopMainCategoryMapper.joinSelectList(wrapper, SpmShopMainCategoryQueryVO.class);
    ...
    @Override
    public Page
            <SpmShopMainCategoryQueryVO> page(SpmShopMainCategoryPageDTO request) throws Exception {
        SpmShopMainCategory po = new SpmShopMainCategory();
        BeanUtilsPlus.copy(request, po);
        JoinLambdaWrapper
                <SpmShopMainCategory> wrapper = new JoinLambdaWrapper<>(po);
        Page
                <SpmShopMainCategoryQueryVO> voPage =
                    spmShopMainCategoryMapper.joinSelectPage(
                new Page<>(request.getPageNum(), request.getPageSize()), wrapper, SpmShopMainCategoryQueryVO.class);
        return voPage;
    }
    ...
    public SpmShopMainCategoryQueryVO details(String id) throws Exception {
        ...
        JoinLambdaWrapper
                <SpmShopMainCategory> wrapper = new JoinLambdaWrapper<>(po);
            SpmShopMainCategoryQueryVO voBean = spmShopMainCategoryMapper.joinSelectOne(wrapper, SpmShopMainCategoryQueryVO.class);
        return voBean;
    }
    ...
    public SpmShopMainCategoryQueryVO details(SpmShopMainCategory request) throws Exception {
        JoinLambdaWrapper
                <SpmShopMainCategory> wrapper = new JoinLambdaWrapper<>(request);
            SpmShopMainCategoryQueryVO voBean = spmShopMainCategoryMapper.joinSelectOne(wrapper, SpmShopMainCategoryQueryVO.class);
        return voBean;
    }
