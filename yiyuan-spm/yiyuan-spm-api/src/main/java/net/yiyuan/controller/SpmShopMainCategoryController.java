...
public class SpmShopMainCategoryController {
  @Autowired private SpmShopMainCategoryService spmShopMainCategoryService;
  ...
  @ResponseBody
  public CommonResult<List<SpmShopMainCategoryQueryVO>> list(SpmShopMainCategoryListDTO request)
      throws Exception {
  ...
  @ResponseBody
  public CommonResult<Page<SpmShopMainCategoryQueryVO>> page(SpmShopMainCategoryPageDTO request)
      throws Exception {
  ...
  @ResponseBody
  public CommonResult<String> add(@RequestBody @Validated SpmShopMainCategoryAddDTO request)
      throws Exception {
